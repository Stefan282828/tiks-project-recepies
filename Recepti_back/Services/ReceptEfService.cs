...
namespace FoodExplorer.Services
{
    public class ReceptEfService : IReceptService
    {
        ...
        public async Task<Recept> CreateAsync(ReceptCreateDto dto)
        {
            ...
            var podkategorija = await _context.Podkategorije.FindAsync(recept.PodKategorijaId);
            if (podkategorija == null)
                throw new KeyNotFoundException($"Podkategorija sa ID {recept.PodKategorijaId} ne postoji");
